...
source_dataset="gta5"
path_to_source_dataset="/nfs/s3_common_dataset/GTAV"
target_dataset="cityscapes"
path_to_target_dataset="/nfs/s3_common_dataset/cityscapes"
ACDC_sub="NONE"
target_domain_description="driving"

# unchanged
path_to_source_checkpoint_dir="/nfs/ofs-902-1/object-detection/jiangjing/experiments/PODA/saved_ckpts/seed_${random_seed}/${source_dataset}_${target_dataset}_source"
path_to_source_checkpoint="${path_to_source_checkpoint_dir}/best_deeplabv3plus_resnet_clip_${source_dataset}.pth"
path_to_target_checkpoint_dir="/nfs/ofs-902-1/object-detection/jiangjing/experiments/PODA/saved_ckpts/seed_${random_seed}/${source_dataset}_${target_dataset}_target"
